...
data class YaniMessageDto(
    ...
    val date: Long = 0,
    @Serializable(with = FlexibleBooleanSerializer::class) val deleted: Boolean = false,
    @SerialName("deleted_by_id") val deletedById: Int? = null,
    @Serializable(with = FlexibleBooleanSerializer::class) val edited: Boolean = false,
    ...
    val nickname: String = "",
    @Serializable(with = FlexibleBooleanSerializer::class) val read: Boolean = false,
