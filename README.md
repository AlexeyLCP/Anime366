...
<h1 align="center">Anime366</h1>

<p align="center">
  Неофициальный клиент <a href="https://anime-365.ru/">Anime365</a> для Android TV и Android.<br/>
  Форк <a href="https://github.com/Helandy/YummyTV">YummyTV</a> (CC BY-NC 4.0) под API Anime365.
</p>
...
**Anime366** — нативное Android-приложение для просмотра аниме с Anime365. Проект поддерживает два
...
Anime366 зависит от доступности Anime365. Каталог, поиск, тайтл и плеер ходят в
`https://anime-365.ru/api`. Соцфункции YummyAnime (комментарии, блогеры, ЛС) в этом форке отключены.

Для логина по паролю нужен `app` id со страницы
[создания API-клиента](https://anime-365.ru/api-clients) — поле `anime365.appId` в `gradle.properties`.
Токен для отладки: `anime365.accessToken` в `local.properties` (не коммитить).
...
- Anime366 — неофициальный клиент Anime365, форк YummyTV.
